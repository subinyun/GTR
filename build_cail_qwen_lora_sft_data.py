...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--embedding-cache", type=Path, default=Path("artifacts/cail2018_gtr_v2_only/full/cache/bge_m3_cail_embeddings_random_trfull_vafull_tefull_seed42.npz"))
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/cail2018_gtr_v2_only/full/qwen3_8b_lora_sft/data"))
